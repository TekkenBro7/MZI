class GOST3411 {
    ...
    _initConstants() {
        ...
        if (this.output_size === 512) {
            this.h = 0x0064;  // Для 512-битного выхода
        } else {
            this.h = 0x0164;  // Для 256-битного выхода
        }
        
        this.N = 0;
        this.sigma = 0;
        
        // Таблица подстановок π (S-блок)
        this.S_BOX = [
        ...
        // Константы C[i] для функции KeySchedule
        this.C = [];
        for (let i = 0; i < 12; i++) {
    ...
    _lTransform(data) {
        /** L-преобразование: умножение 64-битного вектора на матрицу A 64x64 согласно ГОСТ 34.11 */
        let result = 0n;
